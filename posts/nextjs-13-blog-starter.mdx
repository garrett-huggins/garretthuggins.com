...
abstract: Create a dynamic markdown blog using NextJS 13's new app directory.
postedDate: "2022-11-16"
---
...
![Pages directory image](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/6a8pdl6mw1fajsryzefz.png)
...
![Page directory example image](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qqebf90xvyeyogzry268.png)

This would be routed by NextJS as 3 different pages `/about` , `/blog` , and `/`.

#### New app directory:

![App directory example image](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/975ke9okcx14pzm5i85r.PNG)
